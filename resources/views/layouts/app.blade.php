...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a class="btn btn-link" href="{{ route('language.change', ['en']) }}">English</a>
                <a class="btn btn-link" href="{{ route('language.change', ['vi']) }}">Vietnam</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}">{{ __('index.register') }}</a>
                                </li>
                            @endif
                        @else
    ...
    <script >
        ...
        $('#remove_form').submit(()=>{
            let conf = confirm('Do you want delete this');
            if (conf) {
                return true
            }
            return false
